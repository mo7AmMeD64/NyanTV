...
Future<void> fetchSimklCalendarData(RxList<Media> callbackData,
    {bool isMovies = false}) async {
  ...
  if (response.statusCode == 200) {
    ...
    Logger.i(
        'Fetched ${callbackData.length} total Simkl calendar items so far.');
  } else {
    Logger.i('Error: ${response.body}');
    throw Exception(
        'Failed to load Simkl calendar data: ${response.statusCode}');
  }
}
